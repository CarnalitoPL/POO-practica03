    ...
    internal class clGlobales
    {
        public static class Globales
        {
            public static class globales
            {
                ...
                static public string miconexion = @"Data Source=PRADOROBOT\SQLEXPRESS;Initial Catalog=northwind;Integrated Security=True;Encrypt=True;TrustServerCertificate=True";
            }
        }
    }
}
